...
**** What we have shown
+ Some line pairs have promuse for determining the T but in all cases there are serious issues
...
Applications to: 
1. Fine structure profiles.  These are just a collection of dirac deltas
